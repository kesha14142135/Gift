...
public class HeightUpdateDialogFragment extends DialogFragment implements View.OnClickListener, ObservableHorizontalScrollView.OnScrollChangedListener {
    ...
    public static HeightUpdateDialogFragment newInstance(int min, int max, int currentValue) {
        HeightUpdateDialogFragment fragment = new HeightUpdateDialogFragment();
        Bundle args = new Bundle();
        args.putInt(Constant.MIN_VALUE, min);
        args.putInt(Constant.MAX_VALUE, max);
        args.putInt(Constant.VALUE, currentValue);
