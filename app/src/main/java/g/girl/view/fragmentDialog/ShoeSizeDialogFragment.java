...
public class ShoeSizeDialogFragment extends DialogFragment implements View.OnClickListener, ObservableHorizontalScrollView.OnScrollChangedListener {
    ...
    public static ShoeSizeDialogFragment newInstance(int min, int max) {
        ShoeSizeDialogFragment fragment = new ShoeSizeDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewTitle.setText(getResources().getString(R.string.shoe_size));
